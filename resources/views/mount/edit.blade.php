                        ...
                        <div class="panel panel-default">
                            ...
                            <form method="POST" action="/mount/{{ $mount->id }}" class="form-horizontal">
										...
										<div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input class="form-control" name="name" type="text" id="name" value="{{$mount->name}}">
                                            </div>
                                        </div>
										<div class="form-group">
                                            <label for="high" class="col-md-4 control-label">high: </label>
                                            <div class="col-md-6">
                                                <input class="form-control" name="high" type="text" id="high" value="{{$mount->high}}">
                                            </div>
                                        </div>
										<div class="form-group">
                                            <label for="famous" class="col-md-4 control-label">famous: </label>
                                            <div class="col-md-6">
                                                <input class="form-control" name="famous" type="text" id="famous" value="{{$mount->famous}}">
                                            </div>
                                        </div>
										<div class="form-group">
                                            <label for="area" class="col-md-4 control-label">area: </label>
                                            <div class="col-md-6">
                                                <input class="form-control" name="area" type="text" id="area" value="{{$mount->area}}">
                                            </div>
                                        </div>
