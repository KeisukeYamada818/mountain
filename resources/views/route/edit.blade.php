                        ...
                        <div class="panel panel-default">
                            ...
                            <form method="POST" action="/route/{{ $route->id }}" class="form-horizontal">
										...
										<div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input class="form-control" name="mount_id" type="text" id="mount_id" value="{{$route->mount_id}}">
                                            </div>
                                        </div>
										<div class="form-group">
                                            <label for="level" class="col-md-4 control-label">level: </label>
                                            <div class="col-md-6">
                                                <input class="form-control" name="level" type="text" id="level" value="{{$route->level}}">
                                            </div>
                                        </div>
										<div class="form-group">
                                            <label for="times" class="col-md-4 control-label">times: </label>
                                            <div class="col-md-6">
                                                <input class="form-control" name="times" type="text" id="times" value="{{$route->times}}">
                                            </div>
                                        </div>
										<div class="form-group">
                                            <label for="diff" class="col-md-4 control-label">diff: </label>
                                            <div class="col-md-6">
                                                <input class="form-control" name="diff" type="text" id="diff" value="{{$route->diff}}">
                                            </div>
                                        </div>
										<div class="form-group">
                                            <label for="detail" class="col-md-4 control-label">detail: </label>
                                            <div class="col-md-6">
                                                <input class="form-control" name="detail" type="text" id="detail" value="{{$route->detail}}">
                                            </div>
                                        </div>
