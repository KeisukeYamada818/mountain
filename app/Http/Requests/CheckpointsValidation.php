...
//*************************************************************
// Rule
//1.  use App\Http\Requests\CheckpointsValidation; //Add Controller
//2.  public function store( CheckpointsValidation $request ){ //example
//*************************************************************

class CheckpointsValidation extends FormRequest
{
    /**
