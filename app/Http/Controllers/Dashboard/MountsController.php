...
class MountsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view("dashboard.mount.index", compact("mount"));
    }
    ...
    {
        return view("dashboard.mount.create");
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('dashboard.mount.index')->with("flash_message", "mount added!");
    }
    ...
    public function show($mount)
    {
        ...
        return view("dashboard.mount.show", compact("mount"));
    }
    ...
    public function edit($id)
    {
        ...
        return view("dashboard.mount.edit", compact("mount"));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('dashboard.mount.index')->with("flash_message", "mount updated!");
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('dashboard.mount.index')->with("flash_message", "mount deleted!");
    }
}
    //=======================================================================
