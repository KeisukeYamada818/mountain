...
class RoutesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // }
        $route = Route::all();
        return view("dashboard.route.index", compact("route"));
    }
    ...
    {
        $mounts = Mount::All();
        return view("dashboard.route.create", compact('mounts'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('dashboard.route.index')->with("flash_message", "route added!");
    }
    ...
    public function show($id)
    {
        ...
        return view("dashboard.route.show", compact("route"));
    }
    ...
    public function edit($id)
    {
        ...
        return view("dashboard.route.edit", compact("route"));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('dashboard.route.index')->with("flash_message", "route updated!");
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('dashboard.route.index')->with("flash_message", "route deleted!");
    }
}
    //=======================================================================
